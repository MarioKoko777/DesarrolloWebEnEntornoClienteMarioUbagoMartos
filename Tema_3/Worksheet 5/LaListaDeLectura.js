...
// ---------------------
// Ejemplo de uso
const libro1 = new Book("Cien Años de Soledad", "Novela", "Gabriel García Márquez");
const libro2 = new Book("El Principito", "Infantil", "Antoine de Saint-Exupéry");
const libro3 = new Book("1984", "Distopía", "George Orwell");
const miLista = new BookList();
miLista.add(libro1);
miLista.add(libro2);
miLista.add(libro3);
miLista.mostrarResumen();
// Leer el libro actual
miLista.finishCurrentBook();
miLista.mostrarResumen();
